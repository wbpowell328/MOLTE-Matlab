function [tour, minVal] = DeterministicTSP(cities, curr_city, root, dist, ub)
...
if n_cities == 2
    other = setdiff(cities, curr_city);
    tour = [curr_city, other, root];
    minVal = dist(curr_city, other) + dist(other, root);
    return;
end
finalVals = [];
finalNode = [];
